...
export default function Demo(
  ...
  useEffect(() => {
    console.log("Demo component - isSDKLoaded", isSDKLoaded);
    console.log("Demo component - context", context);
    console.log("Demo component - context.user", context?.user);
    console.log("Demo component - context.user.fid", context?.user?.fid);
    console.log("Demo component - address", address);
    console.log("Demo component - isConnected", isConnected);
    console.log("Demo component - chainId", chainId);
    ...
    >
      <div className="w-[300px] mx-auto py-2 px-2">
        ...
        <div className="mb-4">
          ...
          {isContextOpen && (
            <div className="p-4 mt-2 bg-neutral-800 rounded-lg">
        ...
        <div>
          ...
          <div className="mb-4">
            <div className="p-2 bg-neutral-800 rounded-lg my-2">
              <pre className="font-mono text-xs whitespace-pre-wrap break-words max-w-[260px] overflow-x-">
                sdk.actions.signIn
              </pre>
            </div>
...
function SignIn() {
  ...
  console.log("SignIn component - Session status:", status);
  console.log("SignIn component - Session data:", session);

  const getNonce = useCallback(async () => {
    const nonce = await getCsrfToken();
    console.log("SignIn - Got nonce:", nonce);
  ...
  const handleSignIn = useCallback(async () => {
    try {
      ...
      console.log("SignIn - Calling sdk.actions.signIn with nonce:", nonce);
      const result = await sdk.actions.signIn({ nonce });
      console.log("SignIn - SDK signIn result:", result);
      setSignInResult(result);

      console.log("SignIn - Calling NextAuth signIn with credentials");
      const authResult = await signIn("credentials", {
        message: result.message,
        signature: result.signature,
        redirect: false,
      });
      console.log("SignIn - NextAuth signIn result:", authResult);
    } catch (e) {
      console.error("SignIn - Error during sign in:", e);
  ...
  const handleSignOut = useCallback(async () => {
    try {
      console.log("SignIn - Starting sign out process");
      setSigningOut(true);
  ...
  return (
    <>
      <div>
        ...
        <Input
          id="view-profile-fid bg-neutral-800"
          type="number"
          value={fid}
          className="mb-2"
          onChange={(e) => {
