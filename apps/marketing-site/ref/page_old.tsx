...
export default async function Home() {
  ...
  // const adjustedSubtitleUTC = `${totalCheckinsToday.totalCheckIns.toLocaleString()} check ins on ${formatEndRangeUTC(startOfRange)} (resets 5AM ET)`;
  ...
  return (
    <div className="flex w-full flex-col pb-14 sm:pb-20">
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col md:flex-row items-center justify-between gap-1 sm:gap-2 px-4 pt-4 w-full max-w-sm sm:max-w-xl mx-auto">
          {/* <GlobalStatCard
